 ...
 * Group MP01: GPIO 0...7
 */
#define MP010		(PIN(23,0) | PUD)
#define MP010_GPIO	(MP010 | FUNC(0))
#define MP010_CSn0	(MP010 | FUNC(2))
#define MP011		(PIN(23,1) | PUD)
#define MP011_GPIO	(MP011 | FUNC(0))
#define MP011_CSn1	(MP011 | FUNC(2))
#define MP012		(PIN(23,2) | PUD)
#define MP012_GPIO	(MP012 | FUNC(0))
#define MP012_CSn2	(MP012 | FUNC(2))
#define MP012_NFCSn0	(MP012 | FUNC(3))
#define MP013		(PIN(23,3) | PUD)
#define MP013_GPIO	(MP013 | FUNC(0))
#define MP013_CSn3	(MP013 | FUNC(2))
#define MP013_NFCSn1	(MP013 | FUNC(3))
#define MP014		(PIN(23,4) | PUD)
#define MP014_GPIO	(MP014 | FUNC(0))
#define MP014_CSn4	(MP014 | FUNC(2))
#define MP014_NFCSn2	(MP014 | FUNC(3))
#define MP014_ONANDCSn0	(MP014 | FUNC(5))
#define MP015		(PIN(23,5) | PUD)
#define MP015_GPIO	(MP015 | FUNC(0))
#define MP015_CSn5	(MP015 | FUNC(2))
#define MP015_NFCSn3	(MP015 | FUNC(3))
#define MP015_ONANDCSn1	(MP015 | FUNC(5))
#define MP016		(PIN(23,6) | PUD)
#define MP016_GPIO	(MP016 | FUNC(0))
#define MP016_OEn	(MP016 | FUNC(2))
#define MP017		(PIN(23,7) | PUD)
#define MP017_GPIO	(MP017 | FUNC(0))
#define MP017_WEn	(MP017 | FUNC(2))

/*
 * Group MP02: GPIO 0...4
 */
#define MP020		(PIN(24,0) | PUD)
#define MP020_GPIO	(MP020 | FUNC(0))
#define MP020_BEn0	(MP020 | FUNC(2))
#define MP021		(PIN(24,1) | PUD)
#define MP021_GPIO	(MP021 | FUNC(0))
#define MP021_BEn1	(MP021 | FUNC(2))
#define MP022		(PIN(24,2) | PUD)
#define MP022_GPIO	(MP022 | FUNC(0))
#define MP022_WAITn	(MP022 | FUNC(2))
#define MP023		(PIN(24,3) | PUD)
#define MP023_GPIO	(MP023 | FUNC(0))
#define MP023_DATA_RDn	(MP023 | FUNC(2))

/*
 * Group MP03: GPIO 0...7
 */
#define MP030			(PIN(25,0) | PUD)
#define MP030_GPIO		(MP030 | FUNC(0))
#define MP030_NFCLE		(MP030 | FUNC(2))
#define MP030_ONAND_ADDRVALID	(MP030 | FUNC(5))
#define MP031			(PIN(25,1) | PUD)
#define MP031_GPIO		(MP031 | FUNC(0))
#define MP031_NFALE		(MP031 | FUNC(2))
#define MP031_ONAND_SMCLK	(MP031 | FUNC(5))
#define MP032			(PIN(25,2) | PUD)
#define MP032_GPIO		(MP032 | FUNC(0))
#define MP032_NFWE		(MP032 | FUNC(2))
#define MP032_ONAND_RPn		(MP032 | FUNC(5))
#define MP033			(PIN(25,3) | PUD)
#define MP033_GPIO		(MP033 | FUNC(0))
#define MP033_NFRE		(MP033 | FUNC(2))
#define MP034			(PIN(25,4) | PUD)
#define MP034_GPIO		(MP034 | FUNC(0))
#define MP034_NFRnB0		(MP034 | FUNC(2))
#define MP034_ONAND_INT0	(MP034 | FUNC(5))
#define MP035			(PIN(25,5) | PUD)
#define MP035_GPIO		(MP035 | FUNC(0))
#define MP035_RnB1		(MP035 | FUNC(2))
#define MP035_ONAND_INT1	(MP035 | FUNC(5))
#define MP036			(PIN(25,6) | PUD)
#define MP036_GPIO		(MP036 | FUNC(0))
#define MP036_RnB2		(MP036 | FUNC(2))
#define MP037			(PIN(25,7) | PUD)
#define MP037_GPIO		(MP037 | FUNC(0))
#define MP037_RnB3		(MP037 | FUNC(2))
